...
## ADDENDUM MANUEL 2026-07-04 (survit au regen? NON — regenerer puis re-coller ce bloc)
...
- UI calib: marking press-drag+loupe+snap epipolaire; pending (Enter/Esc, fleches 0.1px, rename, 🗑);
